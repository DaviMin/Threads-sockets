...
def increment_shared_variable():
    global shared_variable # globalni promenna
    for _ in range(1000000):
        # Získání zámku
        lock.acquire() # ten pozaduji zamek, aby se to mohlo dokoncit
        try:
            # Kritická sekce, kde se mění sdílená proměnná
            shared_variable += 1
        finally:
            # Uvolnění zámku
            lock.release() # a tady neni try-except, ale rovnou finally, aby se zamek uvolnil
